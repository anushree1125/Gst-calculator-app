package com.example.gst_calculator_app;
    ...
    public void onClick(View view) {
        ...
        if (view.equals(calculate)) {
            ...
            if(TextUtils.isEmpty(amt)){
                Toast.makeText(CalculationActivity.this,"Enter amount in numbers",Toast.LENGTH_SHORT).show();
            }else if( !(isCheckPattern(amt))){
                Toast.makeText(CalculationActivity.this,"Enter amount in numbers",Toast.LENGTH_SHORT).show();
            }
            else if(TextUtils.isEmpty(view_percent.getText().toString())) {
                Toast.makeText(CalculationActivity.this,"You haven't selected GST percentage",Toast.LENGTH_SHORT).show();
            }else {
                ...
                //sending values
                Intent display_result = new Intent(CalculationActivity.this, Result_display_activity.class);
